from src.core_context.activity.application.queries import GetPlanDetailQuery
from src.core_context.activity.application.read_models import WorkoutPlanDetailReadModel
from src.core_context.activity.domain.errors import PrivatePlanAccessError, WorkoutPlanNotFoundError
