from src.core_context.activity.application.queries import ListMuscleGroupsQuery
from src.core_context.activity.application.read_models import MuscleGroupReadModel
