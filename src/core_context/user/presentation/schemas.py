...
if TYPE_CHECKING:
    from src.core_context.user.application.commands import UpdateFitnessCommand, UpdateUserInfoCommand
...
class UserInfoUpdate(BaseModel):
    ...
    def to_command(self, user_id: int) -> UpdateUserInfoCommand:
        from src.core_context.user.application.commands import UpdateUserInfoCommand
...
class FitnessProfileUpdate(BaseModel):
    ...
    def to_command(self, user_id: int) -> UpdateFitnessCommand:
        from src.core_context.user.application.commands import UpdateFitnessCommand
