...
from src.core_context.nutrition.domain.errors import IncompleteNutritionProfileError, InvalidMealEntryError
from src.core_context.user.contracts.dtos import FitnessGoal, Gender
