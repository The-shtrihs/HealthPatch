from src.core_context.nutrition.application.commands import UpdateMealEntryCommand
...
from src.core_context.nutrition.domain.events import DailyNormAchievedEvent, MealEntryUpdatedEvent
